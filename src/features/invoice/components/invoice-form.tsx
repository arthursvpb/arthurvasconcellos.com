...
import { invoiceDraftSchema, type InvoiceDraftInput } from '@/features/invoice/lib/domain/schema';
import type { DocumentType } from '@/features/invoice/lib/domain/types';
import { useDraftStore, createDefaultDraft } from '@/features/invoice/store/draft-store';
