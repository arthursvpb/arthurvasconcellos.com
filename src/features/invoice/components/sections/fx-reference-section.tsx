...
import { SectionCard, FieldGrid, FieldRow } from '@/features/invoice/components/form-field';
import { Input } from '@/components/ui/input';
import { Button } from '@/components/ui/button';
import { interpolate, useT } from '@/features/invoice/lib/i18n/use-t';
import { fetchLatestRate, PROVIDER_LABEL } from '@/features/invoice/lib/fx/frankfurter-client';
import { fxKey, useSettingsStore } from '@/features/invoice/store/settings-store';
