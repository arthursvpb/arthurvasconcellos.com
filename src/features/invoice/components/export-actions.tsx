...
import { toCanonicalInvoice } from '@/features/invoice/lib/domain/canonical';
import { invoiceDraftSchema } from '@/features/invoice/lib/domain/schema';
...
import type { CanonicalInvoice, DocumentType } from '@/features/invoice/lib/domain/types';
...
export function ExportActions({
  ...
  const onDownload = async () => {
    ...
    setBusy('download');
    try {
      const { downloadInvoicePdf } = await import('@/features/invoice/lib/pdf/export');
